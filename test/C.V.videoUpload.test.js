...
describe('Courses-> Videos-> Video Edit', () => {
    ...
    it('should update video file successfully', async () => {
        ...
        const response = await request(app)
            .patch(`/courses/videoUpload/${testCourse._id}`) // Adjust the endpoint to match your route setup
        ...
        assert.strictEqual(response.body.message, 'Added Video File'); // Check for the expected message
